...
<head>
    ...
    <title>Customer Service Executive Courses</title>
...
<body>
    ...
    <div class="container form-container">
        <h1>Customer Service Executive Courses</h1>

        <h2>Recommended Certifications and Courses</h2>
        <ul>
            <li><a href="https://academy.hubspot.com/courses/delivering-exceptional-customer-support">HubSpot Academy: Customer Service Certification (Free)</a></li>
            <li><a href="https://grow.google/intl/en_in/certificates/">Google Career Certificate: IT Support / Customer Support</a></li>
            <li><a href="https://www.linkedin.com/learning/customer-service-foundations-21620021">LinkedIn Learning – Customer Service Foundations</a></li>
        </ul>
    </div>

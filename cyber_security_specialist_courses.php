...
<head>
    ...
    <title>Cyber Security Specialist Courses</title>
...
<body>
    ...
    <div class="container form-container">
        <h1>Cyber Security Specialist Courses</h1>

        <h2>Recommended Certifications and Courses</h2>
        <ul>
            <li><a href="https://www.coursera.org/professional-certificates/google-cybersecurity">Google Cybersecurity Professional Certificate</a></li>
            <li><a href="https://www.comptia.org/certifications/security">CompTIA Security+</a></li>
            <li><a href="https://www.hackerschool.in/courses/certified-ethical-hacker-ceh/">Certified Ethical Hacker (CEH) – EC-Council</a></li>
            <li><a href="https://www.udemy.com/course/cisco-ccna-cyber-ops-the-complete-course/">Cisco Certified CyberOps Associate</a></li>
        </ul>
    </div>

...
<body>
    <div class="container form-container">
        ...
        <ul>
            <li>
                <a href="https://www.udemy.com/course/securityplus/" class="btn-courses">CompTIA A+</a>
            </li>
            <li>
                <a href="https://www.coursera.org/professional-certificates/google-it-support" class="btn-courses">Google IT Support Professional Certificate (Coursera)</a>
            </li>
            <li>
                <a href="https://www.udemy.com/course/office-365-administration-exam-70-346/" class="btn-courses">Microsoft 365 Certified: Modern Desktop Administrator Associate</a>
            </li>
            <li>
                <a href="https://www.udemy.com/course/securityplus/" class="btn-courses">CompTIA Security+</a>
            </li>
        </ul>
    </div>

    ...
    <style>
        ...
        * {
        ...
        @media (prefers-reduced-motion: reduce) {
            header, .container, .container h2, label, input, button {
                animation: none;
                opacity: 1;
                transform: none;
            }
...
<body>
    <div class="container form-container">
        ...
        <form action="roadmap_result.php" method="post">
            <label for="career">Enter Career Role:</label>
            <input type="text" id="career" name="career" placeholder="e.g. Data Scientist" required>

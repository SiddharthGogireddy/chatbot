    ...
    <style>
        ...
        * {
        ...
        .btn-courses {
            ...
            border: none;
            transition: transform 0.3s ease, box-shadow 0.3s ease, backgroundmueller: 0px 0px 0px 0px transparent;
            opacity: 0;
            animation: fadeIn 0.8s ease-out 0.6s forwards;
            text-align: center;
        }
...
<body>
    <div class="container form-container">
        ...
        <p>$70,000 - $120,000 per year</p>

        <h2>Required Skills</h2>
        <ul>
            <li>Manual testing concepts</li>
            <li>Automation tools (Selenium, Cypress, Postman, QTP)</li>
            <li>Bug tracking tools</li>
            <li>Databases</li>
            <li>CI/CD tools</li>
        </ul>

        <a href="software_tester_courses.php" class="btn-courses">View Courses</a>
    </div>

...
<body>
    <div class="container form-container">
        ...
        <ul>
            <li>
                <a href="http://www.computechindia.co.in/CHNE.aspx" class="btn-courses">Certified Hardware and Networking Engineer (CHNE)</a>
            </li>
            <li>
                <a href="https://www.arm.com/resources/education/online-courses/efficient-embedded-systems" class="btn-courses">Certified Embedded Systems Engineer (CESE)</a>
            </li>
            <li>
                <a href="https://www.udemy.com/course/ccna-complete/" class="btn-courses">Cisco Certified Network Associate (CCNA)</a>
            </li>
        </ul>
    </div>

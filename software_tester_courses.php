...
<head>
    ...
    <title>Software Testing Courses</title>
    ...
    <style>
        ...
        * {
        ...
        @media (prefers-reduced-motion: reduce) {
            header, .container, .container h1, .container ul, .container ul li {
                animation: none;
                opacity: 1;
                transform: none;
            }
...
<body>
    <div class="container form-container">
        ...
        <ul>
            <li><a href="https://www.softwaretestingcertificationcourses.com/">ISTQB Certified Tester – Foundation Level (CTFL)</a></li>
            <li><a href="https://www.theknowledgeacademy.com/in/offers/software-testing-istqb-certification-training-courses/">ISTQB Certified Tester – Advanced Level</a></li>
            <li><a href="https://www.softwaretestingcertificationcourses.com/">Certified Software Tester (CSTE)</a></li>
            <li><a href="https://practicetestgeeks.com/certified-associate-in-software-testing-test/#google_vignette">CAST (Certified Associate in Software Testing)</a></li>
        </ul>
    </div>

...
<head>
    ...
    <title>application_support_engineer_courses</title>
    ...
    <style>
        ...
        * {
        ...
        .btn-courses:hover {
            transform: translateY(-2px);
            box-shadow: 0 4px 8px varinit var(--focus-shadow);
        ...
        @media (prefers-reduced-motion: reduce) {
            header, .container, .container h1, .container h2, .container ul, .container ul li, .container p, .btn-courses {
                animation: none;
                opacity: 1;
                transform: none;
            }
...
<body>
    <div class="container form-container">
        <h1>application_support_engineer_courses</h1>

        <h2>Recommended Certifications</h2>
        <ul>
            <li>
                <a href="https://www.theknowledgeacademy.com/" class="btn-courses" target="_blank">ITIL Professional Certification</a>
            </li>
            <li>
                <a href="https://www.coursera.org/professional-certificates/google-it-support" class="btn-courses" target="_blank">Google IT Support Professional Certificate</a>
            </li>
            <li>
                <a href="https://www.theknowledgeacademy.com/in/offers/comptia-certification-training-courses" class="btn-courses" target="_blank">CompTIA A+ or CompTIA Linux+</a>
            </li>
        </ul>
    </div>
